	...
	xmlhttp.onreadystatechange = function(){
		if(this.readyState==4&&this.status==200){
			...
			for(var u=0;u<data.length;u++){
				createCard(cards,data[u].listingId,data[u].Username,data[u].Type,data[u].Title,data[u].Description,data[u].Address,data[u].PickupTime,data[u].ExpiryDate,data[u].CreationTime,data[u].ImgPath,data[u].dpPath);
			}
